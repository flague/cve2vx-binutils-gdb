...
/* Vendor-specific NM-Carus inspired instructions */
...
#define MATCH_XVLE8_V 0x0000000b
#define MASK_XVLE8_V 0xfc007fff
#define MATCH_XVLE16_V 0x0000500b
#define MASK_XVLE16_V 0xfc007fff
#define MATCH_XVLE32_V 0x0000600b
#define MASK_XVLE32_V 0xfc007fff
#define MATCH_XVSE8_V 0x0000002b
#define MASK_XVSE8_V 0xfc007fff
#define MATCH_XVSE16_V 0x0000502b
#define MASK_XVSE16_V 0xfc007fff
#define MATCH_XVSE32_V 0x0000602b
#define MASK_XVSE32_V 0xfc007fff
...
#define MATCH_XVMSEQVV  0x6000005b
#define MASK_XVMSEQVV  0xfc0fffff
#define MATCH_XVMSEQVX  0x6000405b
#define MASK_XVMSEQVX  0xfc007fff
#define MATCH_XVMSEQVI  0x6000305b
#define MASK_XVMSEQVI  0xfc007fff
#define MATCH_XVMSNEVV  0x6400005b
#define MASK_XVMSNEVV  0xfc0fffff
#define MATCH_XVMSNEVX  0x6400405b
#define MASK_XVMSNEVX  0xfc007fff
#define MATCH_XVMSNEVI  0x6400305b
#define MASK_XVMSNEVI  0xfc007fff
#define MATCH_XVMSLTVV  0x6c00005b
#define MASK_XVMSLTVV  0xfc0fffff
#define MATCH_XVMSLTVX  0x6c00405b
#define MASK_XVMSLTVX  0xfc007fff
#define MATCH_XVMSLTUVV  0x6800005b
#define MASK_XVMSLTUVV  0xfc0fffff
#define MATCH_XVMSLTUVX  0x6800405b
#define MASK_XVMSLTUVX  0xfc007fff
#define MATCH_XVMSLEVV  0x7400005b
#define MASK_XVMSLEVV  0xfc0fffff
#define MATCH_XVMSLEVX  0x7400405b
#define MASK_XVMSLEVX  0xfc007fff
#define MATCH_XVMSLEVI  0x7400305b
#define MASK_XVMSLEVI  0xfc007fff
#define MATCH_XVMSLEUVV  0x7000005b
#define MASK_XVMSLEUVV  0xfc0fffff
#define MATCH_XVMSLEUVX  0x7000405b
#define MASK_XVMSLEUVX  0xfc007fff
#define MATCH_XVMSLEUVI  0x7000305b
#define MASK_XVMSLEUVI  0xfc007fff
#define MATCH_XVMSGTVX  0x7c00405b
#define MASK_XVMSGTVX  0xfc007fff
#define MATCH_XVMSGTVI  0x7c00305b
#define MASK_XVMSGTVI  0xfc007fff
#define MATCH_XVMSGTUVX  0x7800405b
#define MASK_XVMSGTUVX  0xfc007fff
#define MATCH_XVMSGTUVI  0x7800305b
#define MASK_XVMSGTUVI  0xfc007fff
...
#define MATCH_XVMULHSU_VV 0x9800205b
#define MASK_XVMULHSU_VV 0xfc0fffff
#define MATCH_XVMULHSU_VX 0x9800605b
#define MASK_XVMULHSU_VX 0xfc007fff
...
/* Custom VRF addresses.  */
#define CSR_VRFADDR 0x8E0
#define CSR_VCUSTOM0 0x8E1 // Leave space for future use of custom VRF instructions.
#define CSR_VCUSTOM1 0x8E2
#define CSR_VCUSTOM2 0x8E3
#define CSR_VCUSTOM3 0x8E4
#define CSR_VCUSTOM4 0x8E5
#define CSR_VCUSTOM5 0x8E6
...
DECLARE_INSN(xvmseq_vv, MATCH_XVMSEQVV, MASK_XVMSEQVV)
DECLARE_INSN(xvmseq_vx, MATCH_XVMSEQVX, MASK_XVMSEQVX)
DECLARE_INSN(xvmseq_vi, MATCH_XVMSEQVI, MASK_XVMSEQVI)
DECLARE_INSN(xvmsne_vv, MATCH_XVMSNEVV, MASK_XVMSNEVV)
DECLARE_INSN(xvmsne_vx, MATCH_XVMSNEVX, MASK_XVMSNEVX)
DECLARE_INSN(xvmsne_vi, MATCH_XVMSNEVI, MASK_XVMSNEVI)
DECLARE_INSN(xvmslt_vv, MATCH_XVMSLTVV, MASK_XVMSLTVV)
DECLARE_INSN(xvmslt_vx, MATCH_XVMSLTVX, MASK_XVMSLTVX)
DECLARE_INSN(xvmsltu_vv, MATCH_XVMSLTUVV, MASK_XVMSLTUVV)
DECLARE_INSN(xvmsltu_vx, MATCH_XVMSLTUVX, MASK_XVMSLTUVX)
DECLARE_INSN(xvmsle_vv, MATCH_XVMSLEVV, MASK_XVMSLEVV)
DECLARE_INSN(xvmsle_vx, MATCH_XVMSLEVX, MASK_XVMSLEVX)
DECLARE_INSN(xvmsle_vi, MATCH_XVMSLEVI, MASK_XVMSLEVI)
DECLARE_INSN(xvmsleu_vv, MATCH_XVMSLEUVV, MASK_XVMSLEUVV)
DECLARE_INSN(xvmsleu_vx, MATCH_XVMSLEUVX, MASK_XVMSLEUVX)
DECLARE_INSN(xvmsleu_vi, MATCH_XVMSLEUVI, MASK_XVMSLEUVI)
DECLARE_INSN(xvmsgt_vx, MATCH_XVMSGTVX, MASK_XVMSGTVX)
DECLARE_INSN(xvmsgt_vi, MATCH_XVMSGTVI, MASK_XVMSGTVI)
DECLARE_INSN(xvmsgtu_vx, MATCH_XVMSGTUVX, MASK_XVMSGTUVX)
DECLARE_INSN(xvmsgtu_vi, MATCH_XVMSGTUVI, MASK_XVMSGTUVI)
...
DECLARE_INSN(xvmulhsu_vv, MATCH_XVMULHSU_VV, MASK_XVMULHSU_VV)
DECLARE_INSN(xvmulhsu_vx, MATCH_XVMULHSU_VX, MASK_XVMULHSU_VX)
...
DECLARE_INSN(xvle8_v , MATCH_XVLE8_V, MASK_XVLE8_V)
DECLARE_INSN(xvse8_v , MATCH_XVSE8_V, MASK_XVSE8_V)
DECLARE_INSN(xvle16_v , MATCH_XVLE16_V, MASK_XVLE16_V)
DECLARE_INSN(xvse16_v , MATCH_XVSE16_V, MASK_XVSE16_V)
DECLARE_INSN(xvle32_v , MATCH_XVLE32_V, MASK_XVLE32_V)
DECLARE_INSN(xvse32_v, MATCH_XVSE32_V, MASK_XVSE32_V)
#endif /* DECLARE_INSN */
#ifdef DECLARE_CSR
...
DECLARE_CSR(vrfaddr, CSR_VRFADDR, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom0, CSR_VCUSTOM0, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom1, CSR_VCUSTOM1, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom2, CSR_VCUSTOM2, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom3, CSR_VCUSTOM3, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom4, CSR_VCUSTOM4, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vcustom5, CSR_VCUSTOM5, CSR_CLASS_V, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
